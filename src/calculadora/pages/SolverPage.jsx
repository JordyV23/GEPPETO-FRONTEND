...
import { Loader, NavbarGPTO, SidebarGPTO, ImageModal, ModalTutorial } from "../components";
  ...
  return (
    <>
      <TourProvider steps={stepsModule2} startAt={0}>
        <ModalTutorial info={['Continuemos con nuestro viaje!']} booleanState={false} btnInstruction={'Continuemos'}/>
